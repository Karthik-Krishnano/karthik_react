        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <a href="https://teamautoz.com/" role="button" rel="noreferrer" target="_blank">
              ...
              <h5>Computer Vision Engineer <br />(Dec 2020 - Aug 2022)</h5>
              <br />
              <h5>Head of Artificial Intelligence <br />(Aug 2022 - Present)</h5>
              ...
              <ul>
                ...
                <li>Works on OpenCV-Python, YOLO, Detectron2, Pytorch, etc for Image processing tasks like Object Detection, Localization, Segmentation, Classification,etc.</li>
                <li>Worked on the Website Development of the team from frontend to hosting using HTML, CSS, JS, BOOTSTRAP,etc.</li>
                </ul>
            </div>
            <div class="resume-item">
            <a href="https://curiousjr.com/" role="button" rel="noreferrer" target="_blank">
              ...
              <h5>SDE Intern <br />(Feb 2022 - July 2022)</h5>
